...
public:
    ...
    // This is needed for the trimesh on bvh creation, otherwise I get a seg fault,
    // as it isn't able to properly parse for the trimesh faces
	virtual void createBVH() {
		bvh = new BVHNode<TrimeshFace>(faces);
	}
